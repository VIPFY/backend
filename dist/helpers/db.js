...
module.exports = function () {
  ...
  for (var i = 1; i < _lodash2.default.random(40, 50); i++) {
    ...
    }, (0, _defineProperty3.default)(_data$users$push, 'position', fillArray(1, 5, function () {
      return name.title();
    })), (0, _defineProperty3.default)(_data$users$push, 'department', fillArray(1, 5, function () {
      return name.jobArea();
    })), (0, _defineProperty3.default)(_data$users$push, 'admin', random.boolean()), (0, _defineProperty3.default)(_data$users$push, 'salary', finance.amount()), (0, _defineProperty3.default)(_data$users$push, 'likes', fillArray(0, 10, function () {
      return {
        key: lorem.word(),
        value: _lodash2.default.random(0, 500)
      };
    })), (0, _defineProperty3.default)(_data$users$push, 'dislikes', fillArray(0, 10, function () {
      return {
        key: lorem.word(),
        value: _lodash2.default.random(0, 500)
      };
    })), (0, _defineProperty3.default)(_data$users$push, 'notifications', fillArray(0, 10, function () {
      return {
        type: lorem.word(),
        text: lorem.text()
      };
    })), (0, _defineProperty3.default)(_data$users$push, 'phoneNumber', fillArray(1, 4, function () {
      return phone.phoneNumber();
    })), (0, _defineProperty3.default)(_data$users$push, 'recoveryEmail', internet.email()), (0, _defineProperty3.default)(_data$users$push, 'websites', fillArray(0, 4, function () {
      return internet.domainName();
    })), (0, _defineProperty3.default)(_data$users$push, 'languages', fillArray(1, 5, function () {
      return address.countryCode();
    })), (0, _defineProperty3.default)(_data$users$push, 'certificates', fillArray(0, 5, function () {
      return company.bsAdjective();
    })), (0, _defineProperty3.default)(_data$users$push, 'socialProfiles', fillArray(0, 4, function () {
      return {
        site: internet.domainWord(),
        link: internet.domainName()
      };
    })), (0, _defineProperty3.default)(_data$users$push, 'accessGroups', fillArray(0, 5, function () {
      return commerce.department();
    })), (0, _defineProperty3.default)(_data$users$push, 'permissions', fillArray(0, 15, function () {
      return {
        value: _lodash2.default.random(1, 4),
        company: company.companyName()
      };
    })), (0, _defineProperty3.default)(_data$users$push, 'companyApps', fillArray(0, 20, function () {
      return commerce.productName();
    })), (0, _defineProperty3.default)(_data$users$push, 'personalApps', fillArray(0, 20, function () {
      return commerce.productName();
    })), (0, _defineProperty3.default)(_data$users$push, 'personalBillHistory', fillArray(0, 20, function () {
      return finance.amount();
    })), (0, _defineProperty3.default)(_data$users$push, 'companybillhistory', fillArray(0, 20, function () {
      return finance.amount();
    })), (0, _defineProperty3.default)(_data$users$push, 'recoveryOptionCompany', fillArray(0, 3, function () {
      return recoveryOption();
    })), (0, _defineProperty3.default)(_data$users$push, 'recoveryOptionPersonal', fillArray(0, 3, function () {
      return recoveryOption();
    })), _data$users$push));
  }
  return data;
