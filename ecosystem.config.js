module.exports = {
  ...
  deploy : {
    production : {
      ...
      'post-deploy' : 'rm node_modules && npm install && rm -rf dist && node_modules/.bin/babel src -d dist --ignore tests && pm2 startOrRestart ecosystem.config.js --env production'
    },
    dev : {
      user : 'node',
      host : '35.197.80.2',
      ...
      'post-deploy' : 'rm node_modules && npm install && rm -rf dist && node_modules/.bin/babel src -d dist --ignore tests && pm2 startOrRestart ecosystem.config.js'
    }
  }
};