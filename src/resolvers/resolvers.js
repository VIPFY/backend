...
export default {
  ...
  Message: find({ receiver: "PublicUser" }),
  MessageData: find({ sender: "PublicUser", receiver: "MessageGroup" }),
  MessageGroupMembership: find({ groupid: "MessageGroup", unitid: "PublicUser" }),
  MessageTag: find({ unitid: "PublicUser", messageid: "MessageTag" }),
