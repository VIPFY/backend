...
export default {
  ...
  MessageData: find({ sender: "Human", receiver: "MessageGroup" }),
  MessageGroupMembership: find({ groupid: "MessageGroup", unitid: "Human" }),
  MessageTag: find({ unitid: "Human", messageid: "MessageTag" }),
