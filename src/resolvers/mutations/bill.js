...
export default {
  ...
  createStripeUser: requiresRights(["create-payment-data"]).createResolver(
    async (_p, _args, ctx) =>
      ctx.models.sequelize.transaction(async ta => {
        const { models, session } = ctx;
        const {
        ...
        try {
          ...
          if (paymentData.payingoptions && paymentData.payingoptions.stripeid) {
            throw new BillingError({
              message: "There is already a Stripe User",
            });
          }
          ...
          if (
            ...
            throw new BillingError({
              message: "Not all needed Information present",
            });
          }
          ...
          const { legalinformation } = paymentData;
          ...
          const stripeCustomer = await stripe.customers.create({
            ...
            address: {
              ...
              line2: address.address.addition,
